...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="#">HongFei.Sun博客后台</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              ...
              <dd><a href="{{url('aadmin/loginout')}}">退出</a></dd>
            </dl>
          </li>
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='{{url("aadmin/welcome")}}' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
        </div>
    </div>
