...
<div class="x-body">
    ...
    <tbody>
        ...
        <tr>
        <td>
            <div class="layui-unselect layui-form-checkbox checked" lay-skin="primary" data-id='2' attr-id="{{$admin->id}}"><i class="layui-icon">&#xe605;</i></div>
        </td>
        <td>{{$admin->id}}</td>
        <td>{{$admin->name}}</td>
        <td>{{$admin->number}}</td>
        ...
        <td class="td-manage">
            ...
            <a title="编辑"  onclick="x_admin_show('编辑','{{url('aadmin/user/'.$admin->id.'/edit')}}',600,400)" href="javascript:;">
            <i class="layui-icon">&#xe642;</i>
            </a>
            <a onclick="x_admin_show('修改密码','member-password.html',600,400)" title="修改密码" href="javascript:;">
            <i class="layui-icon">&#xe631;</i>
            </a>
            <a title="删除" class="del" attr_id="{{$admin->id}}" href="javascript:;">
            <i class="layui-icon">&#xe640;</i>
            </a>
        </td>
        </tr>
